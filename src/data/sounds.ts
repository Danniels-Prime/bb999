...
export const SOUNDS: Sound[] = [
  // Short Vowels (15)
  { id: 'sv-1',  grapheme: 'ă', example: 'apple',    category: 'Short Vowels', speech: 'short a, apple' },
  { id: 'sv-2',  grapheme: 'ă', example: 'ant',      category: 'Short Vowels', speech: 'short a, ant' },
  { id: 'sv-3',  grapheme: 'ă', example: 'add',      category: 'Short Vowels', speech: 'short a, add' },
  { id: 'sv-4',  grapheme: 'ĕ', example: 'egg',      category: 'Short Vowels', speech: 'short e, egg' },
  { id: 'sv-5',  grapheme: 'ĕ', example: 'elephant', category: 'Short Vowels', speech: 'short e, elephant' },
  { id: 'sv-6',  grapheme: 'ĕ', example: 'end',      category: 'Short Vowels', speech: 'short e, end' },
  { id: 'sv-7',  grapheme: 'ĭ', example: 'igloo',    category: 'Short Vowels', speech: 'short i, igloo' },
  { id: 'sv-8',  grapheme: 'ĭ', example: 'inch',     category: 'Short Vowels', speech: 'short i, inch' },
  { id: 'sv-9',  grapheme: 'ĭ', example: 'if',       category: 'Short Vowels', speech: 'short i, if' },
  { id: 'sv-10', grapheme: 'ŏ', example: 'octopus',  category: 'Short Vowels', speech: 'short o, octopus' },
  { id: 'sv-11', grapheme: 'ŏ', example: 'olive',    category: 'Short Vowels', speech: 'short o, olive' },
  { id: 'sv-12', grapheme: 'ŏ', example: 'odd',      category: 'Short Vowels', speech: 'short o, odd' },
  { id: 'sv-13', grapheme: 'ŭ', example: 'umbrella', category: 'Short Vowels', speech: 'short u, umbrella' },
  { id: 'sv-14', grapheme: 'ŭ', example: 'uncle',    category: 'Short Vowels', speech: 'short u, uncle' },
  { id: 'sv-15', grapheme: 'ŭ', example: 'up',       category: 'Short Vowels', speech: 'short u, up' },

  // Long Vowels (15)
  { id: 'lv-1',  grapheme: 'ā', example: 'ape',     category: 'Long Vowels', speech: 'long a, ape' },
  { id: 'lv-2',  grapheme: 'ā', example: 'acorn',   category: 'Long Vowels', speech: 'long a, acorn' },
  { id: 'lv-3',  grapheme: 'ā', example: 'age',     category: 'Long Vowels', speech: 'long a, age' },
  { id: 'lv-4',  grapheme: 'ē', example: 'eagle',   category: 'Long Vowels', speech: 'long e, eagle' },
  { id: 'lv-5',  grapheme: 'ē', example: 'eat',     category: 'Long Vowels', speech: 'long e, eat' },
  { id: 'lv-6',  grapheme: 'ē', example: 'even',    category: 'Long Vowels', speech: 'long e, even' },
  { id: 'lv-7',  grapheme: 'ī', example: 'ice',     category: 'Long Vowels', speech: 'long i, ice' },
  { id: 'lv-8',  grapheme: 'ī', example: 'ivy',     category: 'Long Vowels', speech: 'long i, ivy' },
  { id: 'lv-9',  grapheme: 'ī', example: 'idea',    category: 'Long Vowels', speech: 'long i, idea' },
  { id: 'lv-10', grapheme: 'ō', example: 'ocean',   category: 'Long Vowels', speech: 'long o, ocean' },
  { id: 'lv-11', grapheme: 'ō', example: 'open',    category: 'Long Vowels', speech: 'long o, open' },
  { id: 'lv-12', grapheme: 'ō', example: 'over',    category: 'Long Vowels', speech: 'long o, over' },
  { id: 'lv-13', grapheme: 'ū', example: 'unicorn', category: 'Long Vowels', speech: 'long u, unicorn' },
  { id: 'lv-14', grapheme: 'ū', example: 'use',     category: 'Long Vowels', speech: 'long u, use' },
  { id: 'lv-15', grapheme: 'ū', example: 'unit',    category: 'Long Vowels', speech: 'long u, unit' },
  ...
  // Vowel Teams (12)
  { id: 'vt-1',  grapheme: 'ai', example: 'rain',  category: 'Vowel Teams', speech: 'long a, rain' },
  { id: 'vt-2',  grapheme: 'ay', example: 'play',  category: 'Vowel Teams', speech: 'long a, play' },
  { id: 'vt-3',  grapheme: 'ea', example: 'beach', category: 'Vowel Teams', speech: 'long e, beach' },
  { id: 'vt-4',  grapheme: 'ee', example: 'tree',  category: 'Vowel Teams', speech: 'long e, tree' },
  { id: 'vt-5',  grapheme: 'ie', example: 'pie',   category: 'Vowel Teams', speech: 'long i, pie' },
  { id: 'vt-6',  grapheme: 'oa', example: 'boat',  category: 'Vowel Teams', speech: 'long o, boat' },
  { id: 'vt-7',  grapheme: 'oe', example: 'toe',   category: 'Vowel Teams', speech: 'long o, toe' },
  { id: 'vt-8',  grapheme: 'oo', example: 'moon',  category: 'Vowel Teams', speech: 'oo, moon' },
  { id: 'vt-9',  grapheme: 'ow', example: 'snow',  category: 'Vowel Teams', speech: 'long o, snow' },
  ...
  { id: 'vt-12', grapheme: 'ue', example: 'blue',  category: 'Vowel Teams', speech: 'long u, blue' },
